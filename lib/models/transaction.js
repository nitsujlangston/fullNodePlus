...
TransactionSchema.mintStart
  .flatMap((params) => Rx.Observable.of({params, payload: Promise.resolve(TransactionSchema.mintAndWrite(params))}))
  .do(({params}) => TransactionSchema.spendStart.next(params))
  .toPromise();

TransactionSchema.spendStart
  .flatMap((params) => Rx.Observable.of({params, payload: Promise.resolve(TransactionSchema.spendAndWrite(params))}))
  .subscribe(({params}) => TransactionSchema.txStart.next(params));

TransactionSchema.txStart
  .flatMap((params) => Rx.Observable.of({params, payload: Promise.resolve(TransactionSchema.txAndWrite(params))}))
  .subscribe(() => {});
